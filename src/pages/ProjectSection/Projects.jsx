...
function Projects({
  ...
  return ( <
      >
      <
      div className = "min-h-screen w-full relative z-10 overflow-hidden flex flex-col justify-start  "
      style = {
        {
  ...
  hoverColor = {
    projects_data[activeProject] ? .hoverColor
  }
  />
  ...
  onMouseLeave = {
    ...
    } >
    {
      projects_data.map((project, i) => ( <
        ...
        /a> <
        p className = {
          `xs: hidden lg:block absolute  -top-10 left-0 w-full h-full text text-[#A89C89] font-bold  text-9xl -z-10 transition-all duration-500 ease-out ${
        ...
        div className = "text text-[#0D0D0D] font-bold flex justify-between items-center"
        href = {
          project.link
        }
        target = "_blank"
        ...
        MoveUpRight className = {
          `w-10 h-10 inline-block text-[#0D0D0D] transition-transform duration-500 ease-out ${
